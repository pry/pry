...
describe "show-doc" do
  ...
  describe "rdoc highlighting" do
    ...
    it "should not syntax highlight `` inside code" do
      ...
      begin
        t = pry_tester(binding)
        Pry.config.color = true
        expect(t.eval("show-doc c#decolumnize")).to match(/ls -l \$HOME/)
        expect(t.eval("show-doc c#decolumnize")).not_to match(/`ls -l \$HOME`/)
      ensure
        Pry.config.color = false
      end
    end
  ...
  describe "on sourcable objects" do
    it "should show documentation for object" do
      ...
      expect(mock_pry(binding, "show-doc hello")).to match(/this is a documentation/)
    end
  end
